      ...
      return Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.picture_as_pdf, size: 80, color: AppTheme.masYellow),
              const SizedBox(height: 16),
              const Text('Prévisualisation PDF'),
              Text(
                'Le fichier peut être téléchargé pour lecture complète', 
        ...
        errorBuilder: (context, error, stackTrace) {
          return Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(Icons.broken_image, size: 80, color: Theme.of(context).disabledColor.withOpacity(0.2)),
  ...
  Widget _buildInfoRow(String label, String value, {Color? color}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.6))),
